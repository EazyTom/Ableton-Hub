...
_ONE_SYL = [
    "fire", "flame", "sky", "sea", "soul", "night", "light", "moon", "star",
    "sun", "dust", "mist", "ice", "gold", "blue", "red", "glow", "spark",
    "wave", "tide", "storm", "bloom", "ember", "stone", "steel", "glass",
    "path", "road", "gate", "wall", "tower", "pulse", "beat", "rhythm",
    "void", "edge", "start", "core", "flux", "mesh", "node", "code",
    "forge", "craft", "birth", "rise", "run", "hold", "call", "find",
    "warp", "beam", "cell", "atom", "ion", "bond", "melt",
    "sage", "rite", "drum", "smoke", "herb", "root", "seed", "bone",
]

# Two syllables: flowing
_TWO_SYL = [
    # Sci-fi / Futuristic
    "plasma", "quantum", "nexus", "orbit", "nebula", "pulsar", "photon",
    "cyborg", "android", "nanite", "drone", "laser", "hyper", "cyber",
    "neural", "digital", "neon", "synthetic", "hybrid", "hologram",
    "reactor", "vector", "matrix", "signal", "portal", "warp", "phase",
    # Ancient
    "ancient", "oracle", "relic", "obelisk", "pyramid", "sphinx", "rune",
    "glyph", "temple", "shrine", "altar", "cipher", "scroll",
    "dragon", "phoenix", "serpent", "falcon", "eagle", "raven",
    # Shamanism
    "spirit", "vision", "ritual", "totem", "sacred", "trance", "journey",
    "medicine", "ancestor", "dreamtime", "ceremony", "drumbeat", "chant",
    "crystal", "quartz", "jade", "opal", "ember",
    # Chemical / Creation
    "compound", "element", "fusion", "reaction",
    "genesis", "emerge", "evolve", "transform", "ignite", "forge",
    "echoes", "horizons", "mountains", "rivers", "oceans", "forests",
    "twilight", "sunset", "sunrise", "crimson", "velvet", "obsidian",
]

# Three syllables: expansive
_THREE_SYL = [
    # Sci-fi / Futuristic
    "infinity", "eternity", "synthetic", "holographic",
    "electromagnetic", "interstellar", "hyperdrive", "cybernetic",
    "nanotechnology", "prototype", "paradigm", "algorithm",
    # Ancient
    "primordial", "archaeic", "mysterious", "legendary", "mythical",
    "cathedral", "monastery", "sanctuary", "monument", "artifact",
    # Shamanism
    "visionary", "ceremonial", "ancestral", "elemental", "spiritual",
    "transcendent", "awakening", "transformation", "illumination",
    # Chemical / Creation
    "catalyst", "synthesis", "molecule", "transmutation", "crystallization",
    "generation", "evolution", "transmutation", "crystallization",
    "symphony", "harmony", "melody", "cascade", "waterfall", "rainbow",
]
